...
namespace FrOnDaL_AIO.Common.Utilities.SpellBlocking
{
    internal class EvadeOthers
    {
        ...
        internal static void Attach(Menu evadeMenu)
        {
            ...
            Menu = new Menu("EvadeOthers", "Block specific skills");
            {
                Menu.Add(new MenuBool("EnabledWDodge", "Enable block"));
                Menu.Add(new MenuSlider("EnabledWHP", "Enable when blood volume <= x%", 100));
            }
        ...
        private static void OnProcessSpellCast(AIBaseClient sender, AIBaseClientProcessSpellCastEventArgs Args)
        {
                    ...
                    if (ally.IsAlly)
                    {
...

                        {
                                ...
                                spellMisc.E.Range)
                            {
                                ...
                                {
                                    spellMisc.E.CastOnUnit(Args.Target);
                                }
                            }
...

                        {
                                ...
                                spellMisc.W.Range)
                            {
                                ...
                                {
                                    spellMisc.W.CastOnUnit(Args.Target);
                                }
                            }
            ...
            if (ally != null)
            {
                if (sender.IsMinion)
                {
                    ...
                    if (ally.IsAlly)
                    {
                        ...
                        {
                            if (Args.Target.IsAlly && Args.Target.Distance(spellMisc.Gamer) <
                               spellMisc.E.Range)
                            {
            ...
            {
                if (Args.Target.Distance(spellMisc.Gamer) < spellMisc.E.Range)
                {
            ...
            {
                if (Args.Target.Distance(spellMisc.Gamer) < spellMisc.W.Range)
                {
                    if (ally != null && ally.IsAlly)
                    {
                        if (EvadeTargetManager.Menu["whitelist"][
